...
import models.{AWAGraphqlActions, AWAGraphqlSchema}
...
class AWAGraphQlController @Inject() (assets: AssetsFinder, gqlSchema: AWAGraphqlSchema, actions: AWAGraphqlActions) extends InjectedController {

  val schema:Schema[AWAGraphqlActions,Unit] = gqlSchema.create
